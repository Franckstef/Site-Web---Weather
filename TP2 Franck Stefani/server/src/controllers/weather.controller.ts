    ...
    public get router() : Router {
        ...
        */
        ...
        router.get('/',this.authHandler, async (req:Request, res: Response) => {
            //Utilisez req.locations et _weatherService.readWeathers pour retourner la météo
            const ville = req.locations;
            
                const json = await this._weatherService.readWeathers(ville);
